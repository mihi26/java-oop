...
public class BaseForm3 extends javax.swing.JPanel {
    ...
    public BaseForm3() {
        ...
        filePath = "src/main/java/controller/STK.DAT";
        path1 = "src/main/java/controller/KH.DAT";
        path2 = "src/main/java/controller/NH.DAT";
        initData();
        loadIdtoBox();
    }
    ...
    private void initComponents() {
        ...
        cbBoxSortType.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbBoxSortTypeActionPerformed(evt);
            }
        });
    ...
    private void cbBoxSortTypeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbBoxSortTypeActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cbBoxSortTypeActionPerformed
